...
import com.example.demo.constant.SecretConstant;
import com.example.demo.jwt.AESSecretUtil;
...
public class JwtHelper {
    ...
    public static void main(String[] args) {
       String jsonWebKey = generateJWT("123", "Judy",
        ...
        Base64Realize encoder = Base64Realize.getEncoder();
        String encode = encoder.encode(jsonWebKey);
        System.out.println("token====="+jsonWebKey);
        System.out.println("token encode===="+encode);
        String decode = encoder.decode(encode);
        System.out.println("token decode====");
        Claims claims =  parseJWT(decode);
